...
import Rx from 'rxjs'
import { Agents, AgentEvents, Actions, ReducerFromKey, Epics, newId, createGame } from './api'
...
const antaresKeysMetaEnhancer = (action) => {
    ...
    if (type.match(/create$/)) {
        ...
        return {
            key: 'games:demo:2' // TODO get from context
        }
    }
}
...
export const News = {
    // TODO log it locally on the agent during origination
